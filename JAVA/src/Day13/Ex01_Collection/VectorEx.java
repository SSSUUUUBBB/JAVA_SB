...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		// 개수, 용량 확인
		System.out.println("개수 : " + vector.size());		//.size : 개수
		System.out.println("용량 : " + vector.capacity());	//.capacity : 용량 ( 처음 용량보다 요소가 많이 추가되면 2배로 늘어남(10>20))
		System.out.println();
		...
		// 컬렉션.isEmpty() : 요소가 하나도 없으면 true, 있으면 false
		if( vector.isEmpty() ) {
