...
public class DateEx {
	...
	public static void main(String[] args) throws ParseException {
		...
		// Date.getTime()
		// : 1970년 1월 1일 0시 0분 0초 부처 Date에 지정된 날짜/시간 까지의 ms(밀리초) 누적값
		...
		long dayTime = (1000*60*60*24); // 1일 : ms단위로 환산
		...
		after5Days.setTime(today.getTime() + day5TimeValue );  //setTime 은 ms 단위 
